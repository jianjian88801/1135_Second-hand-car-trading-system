<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='cheliang' && sessionTable != 'shangjia'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' && sessionTable != 'shangjia'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="cheliangLiuyanText">
                        <el-input type="textarea"  :readonly="ro.cheliangLiuyanText" v-model="ruleForm.cheliangLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangLiuyanText" label="留言内容" prop="cheliangLiuyanText">
                            <span v-html="ruleForm.cheliangLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.cheliangId = true;//汽车
                this.ro.yonghuId = true;//用户
                this.ro.cheliangLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`cheliangLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.cheliangLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
