    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="汽车名称" prop="cheliangName">
                       <el-input v-model="ruleForm.cheliangName"
                                 placeholder="汽车名称" clearable  :readonly="ro.cheliangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="汽车品牌" prop="cheliangTypes">
                        <el-select v-model="ruleForm.cheliangTypes" :disabled="ro.cheliangTypes" placeholder="请选择汽车品牌">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格" prop="cheliangNewMoney">
                       <el-input v-model="ruleForm.cheliangNewMoney"
                                 placeholder="价格" clearable  :readonly="ro.cheliangNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="价格" prop="cheliangNewMoney">
                           <el-input v-model="ruleForm.cheliangNewMoney"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="汽车介绍" prop="cheliangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangContent" label="汽车介绍" prop="cheliangContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    cheliangPhoto: false,
                    cheliangTypes: false,
                    cheliangNewMoney: false,
                    cheliangClicknum: false,
                    zanNumber: false,
                    caiNumber: false,
                ...
                rules: {
                   ...
                   cheliangContent: [
                              { required: true, message: '汽车介绍不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
