    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                ShangjiaEntity shangjia = shangjiaService.selectById(forum.getShangjiaId());
                if(shangjia != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setShangjiaId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("shangjia_id", forum.getShangjiaId())
...
//                            forumEntity.setShangjiaId(Integer.valueOf(data.get(0)));   //商家 要改的
